...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void btnTaBort_Click(object sender, EventArgs e)
        {
            ...
            if (!godkandUrl)
            {
                MessageBox.Show("V�nligen tryck p� den podcast du vill ta bort och �ndra inte rss l�nken!");
            }
        ...
        private void btnRedigeraPodd_Click(object sender, EventArgs e)
        {
            ...
            Podd redigeradPodd = new Podd(url, titel, namn, kategori); // samma kod som i LaggTillPodd, l�sa det b�ttre?
        ...
        private void btnRedigeraKategori_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Ett fel har uppst�tt");
            }
        }
